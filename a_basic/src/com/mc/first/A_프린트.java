...
public class A_프린트 {
	...
	public static void main(String[] args) {
		...
		// 			 %.2f: 소수점아래 2자리까지 표기
		System.out.printf("내 이름은 %s, 나이는 %d, 키는 %.2f 입니다.", "이도명", 25, height);
		
		System.out.println();
		System.out.println("========================================");
		
		System.out.printf("%10s: 2,500원", "김밥");
		System.out.println();
		System.out.printf("%10s: 3,000원", "라면");
		System.out.println();
		System.out.printf("%10s: 5,000원", "김치볶음밥");
		System.out.println();
