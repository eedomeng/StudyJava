...
public class I_CoffeeManager {
	...
	public static void main(String[] args) {
		int balance = 100000; // 잔고: 100,000원
		int salesPrice = 0; // 매출
		int expences = 0;// 지출

		int americanoPrice = 3000; // 아메리카노 판매가: 3,000원
		int americanoCost = 2000; // 아메리카노 매입가: 2,000원
		int americanoStock = 10; // 아메리카노 재고: 10개
		int americanoSaftyStock = 3; // 아메리카노 안전재고: 3개
		int americanoSalesCnt = 0; // 아메리카노 판매량

		int mocaPrice = 4000; // 모카 판매가: 4,000원
		int mocaCost = 3000; // 모카 매입가: 3,000원
		int mocaStock = 10; // 모카 재고: 10개
		int mocaSaftyStock = 3; // 모카 안전재고: 3개
		int mocaSalesCnt = 0; // 모카 판매량

		int lattePrice = 5000; // 라떼 판매가: 5,000원
		int latteCost = 4000; // 라떼 매입가: 4,000원
		int latteStock = 10; // 라떼 재고: 10개
		int latteSaftyStock = 3; // 라떼 안전재고: 3개
		...
		while (true) {
			...
			if (inputMenu == 1) {
				...
				System.out.println("\n 아메리카노 재고: " + americanoStock + "| 판매량: " + americanoSalesCnt);
				System.out.println("\n 모카 재고: " + mocaStock + "| 판매량: " + mocaSalesCnt);
				System.out.println("\n 라떼 재고: " + latteStock + "| 판매량: " + latteSalesCnt);
