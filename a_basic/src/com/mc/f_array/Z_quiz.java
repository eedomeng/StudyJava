...
public class Z_quiz {
	...
	private static void q1() {
		...
		int[] iArr = { 1, 3, 5, 7, 9 };
		System.out.println("변경전: " + Arrays.toString(iArr));
...
//			int random = (int)Math.random() * 100; // 0 ~ 0.999999999999 => 0 * 100 ~ 0.999999999999 * 100
//			System.out.println(random);
//		}

		for (int i = 0; i < randomArr.length; i++) {
			int random = (int) (Math.random() * 100) + 1; // 0 ~ 99 + 1 => 1 ~ 100
			randomArr[i] = random;
		}
