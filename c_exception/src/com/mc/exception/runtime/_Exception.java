...
public class _Exception {
	...
	// Checked Exception: 코드로 예외 발생을 차단할 수 없기 때문에, 예외 처리를 강제하는 Exception
	// Unchecked Exception: 코드로 예외 발생을 차단할 수 있기 때문에, 예외 처리를 강제하지 않는 Exception

	// 예외 처리 방법
	// try-catch문: try 블록에 예외가 발생할 수 있는 코드를 작성, catch 블록에 예외처리에 필요한 코드를 작성
	...
	public void arithEx() {
		...
		while (true) {
			...
			System.out.print("피제수 하나를 정수로 입력하세요: ");
			int num = sc.nextInt();
...
//			}
			...
			// 다형성을 이용해 try 블록에서 발생하는 모든 예외에 대해 일괄적인 예외 처리를 적용
//			} catch (Exception e) {
//				System.out.println("예외가 발생했습니다.");
//				System.out.println(e.getMessage());
//			}
