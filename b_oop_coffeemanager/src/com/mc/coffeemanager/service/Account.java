...
public class Account {
	...
	// SingleTon 패턴
	// 한번만 생성 해야하는 클래스가 있을 경우 사용
	private static final Account ACCOUNT = new Account();
	// Account.ACCOUNT
	// Account.getInstance(): 위 아래 코드는 같지만 읽는 개발자들이 singleton 방식으로 생성된 인스턴스라는 것을 바로 알게해줌
	...
	public String toString() {
		return "Account [balance=" + balance + ", salesVolumn=" + salesVolumn + ", expences=" + expences + "]";
	}
